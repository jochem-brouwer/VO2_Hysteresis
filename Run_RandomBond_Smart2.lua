...
MyLattice:InitRandomBond(0.5,1,true);
...
function Model:Measure(Lattice)
    ...
    --print(Out.M, Lattice.ExternalField)
...
local TurnPoints = {1.8, -1.2, 4, -1.7, 1.2, -4}
local Params = {
	TurnPoints = TurnPoints;
}

DataOut = Model:Run(Params, 'SmartCycle',{Sweeps = MyLattice.x*MyLattice.y*MyLattice.z*1000, Plot = false, Save = true});
...
local g = gp{    
    ...
    terminal = "png";
    ["title  font"] = "\",20\"";
    title = "Resistance a function of field";
