...
MyLattice:InitRandomBond(0.6,1);
...
local Field = linspace(-3.5, 250,1.5);
local Field2 = linspace(1.5,75,0)
local Field3 = linspace(0,35*5,3.5);
local Field4 = linspace(3.5,50*5,-1.5)
local Field5 = linspace(-1.5,15*5,0);
local Field6 = linspace(0,35*5,-3.5)
